  ...
  if object_id ('"dbo_mig"."stage_fccm_trunc__dbt_tmp_temp_view"','V') is not null
      begin
      drop view "dbo_mig"."stage_fccm_trunc__dbt_tmp_temp_view"
      end
  ...
  USE [papakura_20221223];
  if object_id ('"dbo_mig"."stage_fccm_trunc__dbt_tmp"','U') is not null
      begin
      drop table "dbo_mig"."stage_fccm_trunc__dbt_tmp"
      end


   USE [papakura_20221223];
   EXEC('create view "dbo_mig"."stage_fccm_trunc__dbt_tmp_temp_view" as
    with base as (SELECT
...
FROM
"papakura_20221223"."dbo_mig"."stage_debt" DEBT
left join "papakura_20221223"."dbo"."LEDGER" L ON L.LEDGERID = DEBT.DLEDGER
...
From base
   ...
   SELECT * INTO "papakura_20221223"."dbo_mig"."stage_fccm_trunc__dbt_tmp" FROM
    "papakura_20221223"."dbo_mig"."stage_fccm_trunc__dbt_tmp_temp_view"
  ...
  if EXISTS (
        SELECT * FROM
        sys.indexes WHERE name = 'dbo_mig_stage_fccm_trunc__dbt_tmp_cci'
        AND object_id=object_id('dbo_mig_stage_fccm_trunc__dbt_tmp')
    )
  DROP index "dbo_mig"."stage_fccm_trunc__dbt_tmp".dbo_mig_stage_fccm_trunc__dbt_tmp_cci
  CREATE CLUSTERED COLUMNSTORE INDEX dbo_mig_stage_fccm_trunc__dbt_tmp_cci
    ON "dbo_mig"."stage_fccm_trunc__dbt_tmp"
