  ...
  if object_id ('"dbo_mig"."stage_cad_unidade_comercial__dbt_tmp_temp_view"','V') is not null
      begin
      drop view "dbo_mig"."stage_cad_unidade_comercial__dbt_tmp_temp_view"
      end
  ...
  USE [papakura_20221223];
  if object_id ('"dbo_mig"."stage_cad_unidade_comercial__dbt_tmp"','U') is not null
      begin
      drop table "dbo_mig"."stage_cad_unidade_comercial__dbt_tmp"
      end


   USE [papakura_20221223];
   EXEC('create view "dbo_mig"."stage_cad_unidade_comercial__dbt_tmp_temp_view" as
    with gpfat as (
    select  
cast(case 
...
LEFT JOIN "papakura_20221223"."dbo_mig"."tab_categoria_tipo_tarifa" TCTT ON TCTT.PLAN_CODE = SC.CCON_PLANID1
...
select * from final2 --where rn = 1
   ...
   SELECT * INTO "papakura_20221223"."dbo_mig"."stage_cad_unidade_comercial__dbt_tmp" FROM
    "papakura_20221223"."dbo_mig"."stage_cad_unidade_comercial__dbt_tmp_temp_view"
  ...
  if EXISTS (
        SELECT * FROM
        sys.indexes WHERE name = 'dbo_mig_stage_cad_unidade_comercial__dbt_tmp_cci'
        AND object_id=object_id('dbo_mig_stage_cad_unidade_comercial__dbt_tmp')
    )
  DROP index "dbo_mig"."stage_cad_unidade_comercial__dbt_tmp".dbo_mig_stage_cad_unidade_comercial__dbt_tmp_cci
  CREATE CLUSTERED COLUMNSTORE INDEX dbo_mig_stage_cad_unidade_comercial__dbt_tmp_cci
    ON "dbo_mig"."stage_cad_unidade_comercial__dbt_tmp"
