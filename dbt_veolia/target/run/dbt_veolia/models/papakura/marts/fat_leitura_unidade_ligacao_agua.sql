  ...
  if object_id ('"dbo_mig"."fat_leitura_unidade_ligacao_agua__dbt_tmp_temp_view"','V') is not null
      begin
      drop view "dbo_mig"."fat_leitura_unidade_ligacao_agua__dbt_tmp_temp_view"
      end
  ...
  USE [papakura_20221223];
  if object_id ('"dbo_mig"."fat_leitura_unidade_ligacao_agua__dbt_tmp"','U') is not null
      begin
      drop table "dbo_mig"."fat_leitura_unidade_ligacao_agua__dbt_tmp"
      end


   USE [papakura_20221223];
   EXEC('create view "dbo_mig"."fat_leitura_unidade_ligacao_agua__dbt_tmp_temp_view" as
...
select *,row_number() over(partition by ID_UNIDADE_LIGACAO_AGUA order by flula.DT_MES_REF_LEITURA asc) as NR_SEQUENCIAL  from flula
   ...
   SELECT * INTO "papakura_20221223"."dbo_mig"."fat_leitura_unidade_ligacao_agua__dbt_tmp" FROM
    "papakura_20221223"."dbo_mig"."fat_leitura_unidade_ligacao_agua__dbt_tmp_temp_view"
  ...
  if EXISTS (
        SELECT * FROM
        sys.indexes WHERE name = 'dbo_mig_fat_leitura_unidade_ligacao_agua__dbt_tmp_cci'
        AND object_id=object_id('dbo_mig_fat_leitura_unidade_ligacao_agua__dbt_tmp')
    )
  DROP index "dbo_mig"."fat_leitura_unidade_ligacao_agua__dbt_tmp".dbo_mig_fat_leitura_unidade_ligacao_agua__dbt_tmp_cci
  CREATE CLUSTERED COLUMNSTORE INDEX dbo_mig_fat_leitura_unidade_ligacao_agua__dbt_tmp_cci
    ON "dbo_mig"."fat_leitura_unidade_ligacao_agua__dbt_tmp"
