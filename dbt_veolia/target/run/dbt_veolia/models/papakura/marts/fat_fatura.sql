  ...
  if object_id ('"dbo_mig"."fat_fatura__dbt_tmp_temp_view"','V') is not null
      begin
      drop view "dbo_mig"."fat_fatura__dbt_tmp_temp_view"
      end
  ...
  USE [papakura_20221223];
  if object_id ('"dbo_mig"."fat_fatura__dbt_tmp"','U') is not null
      begin
      drop table "dbo_mig"."fat_fatura__dbt_tmp"
      end


   USE [papakura_20221223];
   EXEC('create view "dbo_mig"."fat_fatura__dbt_tmp_temp_view" as
...
"papakura_20221223"."dbo_mig"."stage_faturas" fat
left join "papakura_20221223"."dbo_mig"."stage_fatura_register" reg on cast(reg.GBIINVOICE as varchar) = cast(fat.GBIINVOICE as varchar)
left JOIN "papakura_20221223"."dbo_mig"."stage_fatura_componente" c ON c.COD_FATURA = fat.GBIINVOICE
left JOIN "papakura_20221223"."dbo_mig"."stage_fatura_gastos" gastos on gastos.GBIINVOICE = fat.GBIINVOICE
...
-- left join "papakura_20221223"."dbo_mig"."stage_situacao_fatura" S ON S.GBIINVOICE = fat.GBIINVOICE
LEFT JOIN "papakura_20221223"."dbo_mig"."stage_fatura_consumohist" CONSUMO_HIST ON CONSUMO_HIST.GBIINVOICE = fat.GBIINVOICE
LEFT JOIN "papakura_20221223"."dbo_mig"."stage_fatura_fsu" FSU ON FSU.MIG_ID_FATURA_TEMP = fat.GBIINVOICE
LEFT JOIN "papakura_20221223"."dbo_mig"."stage_ap" AP  ON AP.MIG_STATEMENT_TEMP_ADJ = fat.GBISTATEMENT_NO
LEFT JOIN "papakura_20221223"."dbo_mig"."stage_payment" P ON cast(P.id_conta_corrente as varchar) = cast(fat.GBILEDGER as varchar)
LEFT JOIN "papakura_20221223"."dbo_mig"."stage_fatura_reghist" HIST ON HIST.GBR$SEQNO = fat.GBIINVOICE
LEFT JOIN "papakura_20221223"."dbo_mig"."cad_unidade_orgao_centralizador" CUOC ON CUOC.CH_MATRICULA_UNIDADE = uc.CH_MATRICULA_UNIDADE
left join "papakura_20221223"."dbo_mig"."stage_fatura_status_pago" SFSP ON  fat.GBIINVOICE = SFSP.GBIINVOICE
left join "papakura_20221223"."dbo_mig"."stage_status_fatura" ssf on ssf.GBIINVOICE = fat.GBIINVOICE
)
...
from fatura
LEFT JOIN "papakura_20221223"."dbo_mig"."cad_fechamentos" cf on cf.MES_REFERENCIA = DT_MESANO_REF and cf.CH_PROCESSO =3
-- WHERE DT_SITUACAO_FATURA <= ''2022-11-01''
    ');

   SELECT * INTO "papakura_20221223"."dbo_mig"."fat_fatura__dbt_tmp" FROM
    "papakura_20221223"."dbo_mig"."fat_fatura__dbt_tmp_temp_view"
  ...
  if EXISTS (
        SELECT * FROM
        sys.indexes WHERE name = 'dbo_mig_fat_fatura__dbt_tmp_cci'
        AND object_id=object_id('dbo_mig_fat_fatura__dbt_tmp')
    )
  DROP index "dbo_mig"."fat_fatura__dbt_tmp".dbo_mig_fat_fatura__dbt_tmp_cci
  CREATE CLUSTERED COLUMNSTORE INDEX dbo_mig_fat_fatura__dbt_tmp_cci
    ON "dbo_mig"."fat_fatura__dbt_tmp"
