  ...
  if object_id ('"dbo_mig"."med_rota_leitura_agua_sequencia__dbt_tmp_temp_view"','V') is not null
      begin
      drop view "dbo_mig"."med_rota_leitura_agua_sequencia__dbt_tmp_temp_view"
      end
  ...
  USE [papakura_20221223];
  if object_id ('"dbo_mig"."med_rota_leitura_agua_sequencia__dbt_tmp"','U') is not null
      begin
      drop table "dbo_mig"."med_rota_leitura_agua_sequencia__dbt_tmp"
      end


   USE [papakura_20221223];
   EXEC('create view "dbo_mig"."med_rota_leitura_agua_sequencia__dbt_tmp_temp_view" as
...
FROM ROTA_FINAL
LEFT JOIN "papakura_20221223"."dbo_mig"."med_rota_leitura_agua" MRLA ON MRLA.READSEQ = ROTA_FINAL.READSEQ
    ');

   SELECT * INTO "papakura_20221223"."dbo_mig"."med_rota_leitura_agua_sequencia__dbt_tmp" FROM
    "papakura_20221223"."dbo_mig"."med_rota_leitura_agua_sequencia__dbt_tmp_temp_view"
  ...
  if EXISTS (
        SELECT * FROM
        sys.indexes WHERE name = 'dbo_mig_med_rota_leitura_agua_sequencia__dbt_tmp_cci'
        AND object_id=object_id('dbo_mig_med_rota_leitura_agua_sequencia__dbt_tmp')
    )
  DROP index "dbo_mig"."med_rota_leitura_agua_sequencia__dbt_tmp".dbo_mig_med_rota_leitura_agua_sequencia__dbt_tmp_cci
  CREATE CLUSTERED COLUMNSTORE INDEX dbo_mig_med_rota_leitura_agua_sequencia__dbt_tmp_cci
    ON "dbo_mig"."med_rota_leitura_agua_sequencia__dbt_tmp"
